...
| Secret | `AUTH_SECRET` | 32-byte random secret (`openssl rand -base64 32`) |
...
The app is served at `https://<SUBDOMAIN>.<DOMAIN_NAME>`. `DATABASE_URL`,
`AUTH_URL`, and `NEXT_PUBLIC_APP_URL` are generated by Terraform and injected
